        ...
        <div class="row">
          <div class="col-sm-6">
            <!-- <h1>
              ...
              thought I saw the traces of a simple honest heart.
            </h1> -->
          </div>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <p>
              ...
              Pagan, which even his uncouthness could not altogether maim. He
            ...
            <p>
              It may seem ridiculous, but it reminded me of General Washington's
              ...
              likewise very projecting, like two long promontories thickly
            ...
            <p>
              ...
              glance; but appeared wholly occupied with counting the pages of
              the marvellous book. Considering how sociably we had been sleeping
              ...
              savages are strange beings; at times you do not know exactly how
              to take them.
            </p>
          </div>
          <div class="col-sm-6">
            <p>
              ...
              other seamen in the inn. He made no advances whatever; appeared to
              have no desire to enlarge the circle of his acquaintances. All
              this struck me as mighty singular; yet, upon second thoughts,
              there was something almost sublime in it. Here was a man some
              twenty thousand miles from home, by the way of Cape Horn, that
            ...
            <p>
              ...
              Cape Horn, that is—which was the only way he could get
              there—thrown among people as strange to him as though he were in
...
onMounted(() => {
  ...
  const hero = ref(null);
  hero.value = document.querySelector('#hero');
